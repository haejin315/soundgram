<!DOCTYPE html>
<!-- saved from url=(0030)mynft.html -->
<html lang="en">
    ...
    <body style="min-width: 1440px; background-color: rgb(249, 251, 253);">
        ...
        <div id="root">
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse" id="responsive-navbar-nav">
                        <div class="ml-auto navbar-nav">
                            ...
                            <a href="mynft.html" class="nav-link">Create</a>
                            <a href="mynft.html" class="nav-link active">My NFTs</a>
                        </div>
                        <div class="navbar-nav" style="margin-left: 1.5rem;">
                            <div class="dropdown">
                                <a href="mynft.html#" style="z-index: 1000;">
            ...
            <div class="mynft-banner">
                <div class="container">
                    <div class="row">
                        <div class="text-center col">
                            <center>
                                <div class="profile-thumb l" style="background-image: url(&quot;/images/profile.svg&quot;);"></div>
                            </center>
                            <h2 style="margin-top: 16px;">sally.kim</h2>
                            <div class="mynft-subtitle" style="cursor: pointer;">
                                <div class="mynft-subtitle">0xde73...f1f6f8</div>&nbsp;<svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M2.74406 2.744C2.90034 2.58772 3.1123 2.49992 3.33331 2.49992H10.8333C11.0543 2.49992 11.2663 2.58772 11.4226 2.744C11.5788 2.90028 11.6666 3.11224 11.6666 3.33325V4.16659C11.6666 4.62682 12.0397 4.99992 12.5 4.99992C12.9602 4.99992 13.3333 4.62682 13.3333 4.16659V3.33325C13.3333 2.67021 13.0699 2.03433 12.6011 1.56548C12.1322 1.09664 11.4964 0.833252 10.8333 0.833252H3.33331C2.67027 0.833252 2.03439 1.09664 1.56555 1.56548C1.0967 2.03433 0.833313 2.67021 0.833313 3.33325V10.8333C0.833313 11.4963 1.09671 12.1322 1.56555 12.601C2.03439 13.0699 2.67027 13.3333 3.33331 13.3333H4.16665C4.62688 13.3333 4.99998 12.9602 4.99998 12.4999C4.99998 12.0397 4.62688 11.6666 4.16665 11.6666H3.33331C3.1123 11.6666 2.90034 11.5788 2.74406 11.4225C2.58778 11.2662 2.49998 11.0543 2.49998 10.8333V3.33325C2.49998 3.11224 2.58778 2.90028 2.74406 2.744ZM8.33331 9.16658C8.33331 8.70635 8.70641 8.33325 9.16665 8.33325H16.6666C17.1269 8.33325 17.5 8.70635 17.5 9.16658V16.6666C17.5 17.1268 17.1269 17.4999 16.6666 17.4999H9.16665C8.70641 17.4999 8.33331 17.1268 8.33331 16.6666V9.16658ZM9.16665 6.66659C7.78593 6.66659 6.66665 7.78587 6.66665 9.16658V16.6666C6.66665 18.0473 7.78593 19.1666 9.16665 19.1666H16.6666C18.0474 19.1666 19.1666 18.0473 19.1666 16.6666V9.16658C19.1666 7.78587 18.0474 6.66659 16.6666 6.66659H9.16665Z" fill="#2D3741" fill-opacity="0.4"></path>
                                </svg>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="text-center col">
                            <a class="btn-sm btn btn-kns-outline" href="https://krafter.space/en/profile/edit" style="margin-top: 24px;">Edit Profile</a>
                ...
                <div class="row">
                    <div class="col">
                        <table width="100%">
                            <tbody>
                                <tr class="mynft-tabs">
                                    <td class="tab active">Owned</td>
                                    <td class="tab">Created</td>
                                    <td class="text-right">
                                        <div class="mynft-caption">* Only the NFTs created with KrafterSpace will appear.</div>
                                        <div role="group" class="all-nft-list-dropdown dropdown btn-group">
                                            <button aria-haspopup="true" aria-expanded="false" id="bg-nested-dropdown" type="button" class="dropdown-toggle btn btn-kns-outline">Recently Received</button>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <div class="row flex-row flex-nowrap card-deck">
                                <div class="nft-preview-card card" style="z-index: 1; min-width: 290px; background-color: rgb(220, 230, 240);">
                                    <table class="clickable img" style="width: 290px; height: 290px;">
                                        <tbody>
                                            <tr>
                                                <td class="text-center" style="padding: 29px;"><img loading="lazy" src="./KrafterSpace_files/0xa4f9f672스크린샷 2021-11-04 오후 8.38.20.png" alt="" style="margin-left: auto; background-color: rgb(220, 230, 240); width: 232px; height: 127px;"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <div class="card-body">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="nft-desc-section" style="width: 186px;">
                                                        <a href="https://krafter.space/en/nft/0x9faccd9f9661dddec3971c1ee146516127c34fc1/0xa4f9f672" style="text-decoration: none;">
                                                            <div class="text-ellipsis card-title h5" style="width: 186px;">추억의 드라마 짤 211104</div>
                                                        </a>
                                                        <a href="https://krafter.space/en/userInfo/0xde7311108207b70af23ff6d60828ba8acdf1f6f8" style="text-decoration: none;">
                                                            <p class="card-text">
                                                                <span style="width: 186px;">Created By
                                                                    <span class="author text-ellipsis" style="width: 120px; display: inline-block; vertical-align: bottom;">jack.soundgram</span>
                                                                </span>
                                                            </p>
                                                        </a>
                                                    </td>
                                        ...
                                        <table style="margin: 0px 24px 12px; width: 242px;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="like-section text-right"></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
    ...
    -->  
        ...
        function getAlbumsOnSale() {
            ...
            $.ajax({
                ...
                data: { "wallet_addr" : "0x3ad938c97ed134fc0d978e2148ee082cf98ed26a"  },            // HTTP 요청과 함께 서버로 보낼 데이터
